...
void generateDataFile(const string& filename, int dataSize, int choice) // генерация файла, контейнерами, конструкция на элс-ифа, лайбери для работы с файлами эфстрим
{
